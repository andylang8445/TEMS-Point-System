<?php
    ...
    print '<table id="myTable" border="2"><tr><th align="center" width="40"><button id="id_sec" onclick="sortTable1_1();" style="width:100%; height:25px; font-size:10.2pt"><strong>id &#62;</strong></button></th><th align="center"><button id="name_sec" onclick="sortTable2();" style="width:100%; height:25px; font-size:10.2pt"><strong>name</strong></button></th><th align="center" width="85"><button id="age_sec" onclick="sortTable3();" style="width:100%; height:25px; font-size:10.2pt"><strong>Age</strong></button></th><th align="center"><button id="point_sec" onclick="sortTable4();" style="width:100%; height:25px; font-size:10.2pt"><strong>Point</strong></button></th></tr>';
    for($i=0;$i<$tot;$i++){
        print "<tr>" ; 
